<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Research.aspx.cs" Inherits="CommissionSystem.Research" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
      <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4"><h4>Research</h4>
						</div>
					...
					<div class="row filter-row">
					   ...
					   <div class="col-sm-3 col-md-2 col-xs-6">  
							<div class="form-group form-focus select-focus">
								<label class="control-label">Publications Year</label>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                           <%
                                             ...
                                             var users = nav.ResearchDraft;
                                             int count = 0;
                                             foreach (var research in users)
                                             {
                                                 count++;
                                            %>
										    <tr>
                                            <td><%=count %></td>
                                            <td><%=research.University_Code%></td>
                                            <td><%=research.Cycle%></td>
											<td><%=research.No_of_Publications %></td>
                                            <td><%=research.No_of_Patents%></td>
                                            <td><%=research.No_of_Innovations %></td>
											<td><%=research.Program_Domain%></td>
											<td class="text-right">
												<div class="dropdown">
