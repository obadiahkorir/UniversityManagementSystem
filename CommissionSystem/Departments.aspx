<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Departments.aspx.cs" Inherits="CommissionSystem.Departments" %>
                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-xs-8 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_salary"><i class="fa fa-plus"></i> Add Programme</a>
						</div>
					</div>
