<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Diplomas.aspx.cs" Inherits="CommissionSystem.Diplomas" %>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                         <%
                                             ...
                                             var users = nav.Programs.Where(r=>r.Program_Level=="Diploma");
                                             int count = 0;
