<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FinancialSubmission.aspx.cs" Inherits="CommissionSystem.FinancialSubmission" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
      <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h4 class="page-title">Financial Submissions</h4>
						</div>
					...
					<div class="row filter-row">
					   <div class="col-sm-3 col-md-2 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">University Code</label>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                         <%
                                             ...
                                             var users = nav.FinancialSubmissions;
                                             int count = 0;
                                             foreach (var finance in users)
                                             {
                                                 count++;
                                             %>
									    	<tr>
                                             <td><%=count%></td>
                                            <td><%=finance.University_Code%></td>
                                            <td><%=finance.Year%></td>
											<td><%=finance.AccountsCode %></td>
                                            <td><%=finance.AccountsDescription%></td>
                                            <td><%=finance.AccountsSubCategoryCode%></td>
											<td><%=finance.Description %></td>
                                            <td><%=finance.Category_Code%></td>
											<td class="text-right">
												<div class="dropdown">
