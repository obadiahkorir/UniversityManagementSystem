<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="Campuses.aspx.cs" Inherits="CommissionSystem.Campuses" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
       <div class="page-wrapper">        
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h1 class="page-title">Campuses</h1>
						</div>
						<div class="col-xs-8 text-right m-b-30">
							<a href="#" class="btn btn-primary pull-right rounded" data-toggle="modal" data-target="#add_campus"><i class="fa fa-plus"></i> Add Campus</a>
					...
					<div class="row filter-row">
						<div class="col-sm-3 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">Campus ID</label>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>			
                                         <%
                                             ...
                                             var campuni= nav.campuses;
                                             int count = 0;
                                             foreach (var camp in campuni)
                                             {
                                                 count++;
                                             %>
                                            <tr>
