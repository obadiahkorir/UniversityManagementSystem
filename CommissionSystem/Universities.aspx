<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master"   CodeBehind="Universities.aspx.cs" Inherits="CommissionSystem.Universities" %>
                ...
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-xs-8 text-right m-b-30">
							<a href="#" class="btn btn-primary pull-right rounded" data-toggle="modal" data-target="#add_university"><i class="fa fa-plus"></i> Add University</a>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>			
                                         <%
                                             ...
                                             var university= nav.Customers.Where(r=>r.;
                                             int count = 0;
                                             foreach (var versity in university)
                                             {
                                                 count++;
                                             %>
                                            <tr>
                                             <td><%=count %></td>
                                            <td><%=versity.University_Code%></td>
                                            <td><%=versity.Name%></td>
                                            <td><%=versity.P_I_N%></td>
                                            <td><%=versity.Post_Code%></td>  
                                            <td><%=versity.Address%></td
                                            <td><%=versity.City%></td>
                                            <td><%=versity.E_Mail%></td>
                                            <td><%=versity.Address%></td>
                                            <td><%=versity.Address%></td>
				...
				<div class="modal-dialog">
					...
					<div class="modal-content modal-lg">
						<div class="modal-header">
							<h1 class="modal-title">Add University</h1>
						</div>
