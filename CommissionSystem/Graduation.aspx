<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"  CodeBehind="Graduation.aspx.cs" Inherits="CommissionSystem.Graduation" %>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>			
                                         <%
                                             ...
                                             var gradution= nav.Graduation;
                                             int count = 0;
                                             foreach (var grad in gradution)
                                             {
                                                 count++;
                                             %>
                                            <tr>
                                            <td><%=count %></td>
                                            <td><%=grad.University_Code%></td>
                                            <td><%=grad.Cycle%></td>
                                            <td><%=grad.Student_ID%></td>
                                            <td><%=grad.Program%></td>
                                            <td><%=grad.Surname%></td>
                                            <td><%=grad.Middle_Name%></td>
                                            <td> <%=grad.First_Name%></td>
                                            <td><%=grad.Home_County%></td>
                                            <td><%=grad.Nationality%></td>
                                              <td class="text-right">
												<div class="dropdown">
