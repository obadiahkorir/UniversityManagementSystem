<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master"   CodeBehind="DVC.aspx.cs" Inherits="CommissionSystem.DVC" %>
					...
					<div class="row filter-row">
						<div class="col-sm-3 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">DVC ID</label>
								<input type="text" class="form-control floating" />
							</div>
						</div>
						<div class="col-sm-3 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">DVC Name</label>
								<input type="text" class="form-control floating" />
							</div>
						</div>
						<div class="col-sm-3 col-xs-6"> 
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                         <%
                                             ...
                                             var users = nav.PortalUsers.Where(r=>r.LoginPermissionLevel=="DVC");
                                             int count = 0;
