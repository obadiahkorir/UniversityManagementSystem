<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Bachelors.aspx.cs" Inherits="CommissionSystem.Bachelors" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
         <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						...
						<div class="col-xs-8 text-right m-b-30">
							<a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_University"><i class="fa fa-plus"></i> Add Programme</a>
						</div>
					</div>
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                         <%
                                             ...
                                             var users = nav.Programs.Where(r=>r.Program_Level=="Bachelors");
                                             int count = 0;
                                             foreach (var program in users)
                                             {
                                                 count++;
                                              %>
										<tr>
                                            ...
                                            <td><%=program .Program_Domain %></td>
                                            <td><%=program .Institution_Code %>
                                            <td><%=program.Instiution_Name %></td>
                                            <td><%=program .Program_Level %></td>
                                            <td><%=program .Accreditation_Status %></td>
                                            <td><%=program.Date_of_Approval %></td>
											<td class="text-right">
												<div class="dropdown">
			...
			<div id="add_University" class="modal custom-modal fade" role="dialog">
				<div class="modal-dialog">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<div class="modal-content modal-lg">
						<div class="modal-header">
							<h1 class="modal-title">Add Programmes</h1>
						</div>
