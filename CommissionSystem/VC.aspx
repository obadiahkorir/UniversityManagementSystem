<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="VC.aspx.cs" Inherits="CommissionSystem.VC" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
        <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h4 class="page-title">Vice Chancellor</h4>
						</div>
					...
					<div class="row filter-row">
						<div class="col-sm-3 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">Chancellor  ID</label>
								<input type="text" class="form-control floating" />
							</div>
						</div>
						<div class="col-sm-3 col-xs-6">  
							<div class="form-group form-focus">
								<label class="control-label">Chancellor Name</label>
								<input type="text" class="form-control floating" />
							</div>
						</div>
						<div class="col-sm-3 col-xs-6"> 
								...
								<table class="table table-striped custom-table datatable">
									...
									<tbody>
                                         <%
                                             ...
                                             var users = nav.PortalUsers.Where(r=>r.LoginPermissionLevel=="VC");
                                             int count = 0;
                                             ...
                                             %>
											  ...
											  <td>
											   ...
											   <h2><a href="profile.html"><%=user.Email %> <span>Administrator</span></a></h2>
											   </td>
											   <td><%=user.CustomerNo %></td>
											   <td><%=user.Password%></td>
                                                <td><%=user.Login_Type%></td>
                                                <td><%=user.University_Code%></td>
                                                 <td><%=user.LoginPermissionLevel%></td>
			...
			<div id="add_administrator" class="modal custom-modal fade" role="dialog">
				<div class="modal-dialog">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<div class="modal-content modal-lg">
						<div class="modal-header">
							<h1 class="modal-title">Add Administrators</h1>
						</div>
							...
							<form class="m-b-30">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      <div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Enter Address<span class="text-danger">*</span></label>
											<asp:Textbox ID="txtxaddress" class="form-control" runat="server"></asp:Textbox>
										</div>
									</div>
                                      <div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Enter Phone Number<span class="text-danger">*</span></label>
											<asp:Textbox ID="txtphone" class="form-control" runat="server"></asp:Textbox>
										</div>
									</div>
                                      <div class="col-sm-6">
										<div class="form-group">
											<label class="control-label">Select Post Address<span class="text-danger">*</span></label>
                                                <asp:DropDownList runat="server"  type="number" id="postcode" name="postcode"  class="form-control" style="width: 100%; "/>
										    </div>
										</div>
									</div>
